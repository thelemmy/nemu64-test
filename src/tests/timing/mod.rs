...
impl Test for SingleInstructionCPUTiming {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(&str, u32, u32)] = &[
            // Expensive CPU instructions
            ("DIV", 37u32, Assembler::make_div(GPR::R0, GPR::R0)),
            ("DIVU", 37u32, Assembler::make_divu(GPR::R0, GPR::R0)),
            ("DDIV", 69u32, Assembler::make_ddiv(GPR::R0, GPR::R0)),
            ("DDIVU", 69u32, Assembler::make_ddivu(GPR::R0, GPR::R0)),
            ("MULT", 5u32, Assembler::make_mult(GPR::R0, GPR::R0)),
            ("MULTU", 5u32, Assembler::make_multu(GPR::R0, GPR::R0)),
            ("DMULT", 8u32, Assembler::make_dmult(GPR::R0, GPR::R0)),
            ("DMULTU", 8u32, Assembler::make_dmultu(GPR::R0, GPR::R0)),
            // These are all instant.
            ("MFLO", 1u32, Assembler::make_mflo(GPR::V0)),
            ("MFHI", 1u32, Assembler::make_mfhi(GPR::V0)),
            ("MTLO", 1u32, Assembler::make_mtlo(GPR::V0)),
            ("MTHI", 1u32, Assembler::make_mthi(GPR::V0)),
            ("TLBR", 1u32, Assembler::make_cop0_tlbr()),
            ("TLBP", 1u32, Assembler::make_cop0_tlbp()),
            ("TLBWR", 1u32, Assembler::make_cop0_tlbwr()),
            ("TLBWI", 1u32, Assembler::make_cop0_tlbwi()),
            ("SYNC", 1u32, Assembler::make_sync()),
...
impl Test for Exceptions {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(&str, u64, u64, Status, ExceptionTimingMode, u32, u32)] = &[
            (
                "BREAK",
                0u64,
                0u64,
...
impl Test for COP1Instructions32 {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(&str, u32, f32, f32, u32)] = &[
        ...
        const VALUES_1: &[(&str, u32, f32, f32, ExceptionTimingMode, u32)] = &[
        ...
        const VALUES_2: &[(&str, u32, i32, u32)] = &[
        ...
        const VALUES_3: &[(&str, u32, i32, ExceptionTimingMode, u32)] = &[(
            "CVT.S.W (inexact)",
            10u32,
            1234567891i32,
            ExceptionTimingMode::JustFire,
        ...
        const VALUES_4: &[(&str, u32, i64, u32)] = &[
        ...
        const VALUES_5: &[(&str, u32, i64, ExceptionTimingMode, u32)] = &[
            (
                "CVT.S.L",
                10u32,
                1234567891i64,
...
impl Test for COP1Instructions64 {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(&str, u32, f64, f64, u32)] = &[
        ...
        const VALUES_1: &[(&str, u32, f64, f64, ExceptionTimingMode, u32)] = &[
...
impl Test for CPURegisterDependency {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(&str, u32, u32, u32)] = &[
        ...
        result.extend(crate::tests::boxed_values(VALUES_S));
        result.push(Box::new((
...
impl Test for COP1RegisterDependency {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(&str, u32, f32, f32, u32, u32)] = &[
            // ** Singles **
        ...
        const VALUES_1: &[(&str, u32, f64, f64, u32, u32)] = &[
            // ** Doubles **
            // ADD.S doesn't create a dependency on it's destination register (unlike ADDIU, see above)
            (
                "ADD.D (no dependency)",
