...
fn default_tests() -> Vec<Box<dyn Test>> {
    vec![
        ...
        Box::new(super::address_error_exception::UnalignedLWC1 {}),
        Box::new(super::address_error_exception::UnalignedLWDelay {}),
        Box::new(super::address_error_exception::UnalignedSW {}),
        Box::new(super::address_error_exception::UnalignedCacheData {}),
        Box::new(super::address_error_exception::UnalignedCacheInstruction {}),
        ...
        Box::new(super::arithmetic::shifts::DSRA32 {}),
        Box::new(super::arithmetic::shifts::DSRL32 {}),
        Box::new(super::arithmetic::shifts::DSLL32 {}),
        ...
        Box::new(super::arithmetic::mul::MULT {}),
        Box::new(super::arithmetic::mul::MULTRandomized {}),
        Box::new(super::arithmetic::mul::MULTU {}),
        Box::new(super::arithmetic::mul::DMULT {}),
        Box::new(super::arithmetic::mul::DMULTU {}),
        Box::new(super::arithmetic::hilo::ReadAfterOpWithoutGap {}),
        Box::new(super::arithmetic::hilo::ReadThenStartOp {}),
        ...
        Box::new(super::cache::dcache::WriteBackLB {}),
        Box::new(super::cache::dcache::WriteBackLBU {}),
        Box::new(super::cache::dcache::WriteBackLH {}),
        Box::new(super::cache::dcache::WriteBackLHU {}),
        Box::new(super::cache::dcache::WriteBackLW {}),
        Box::new(super::cache::dcache::WriteBackLWU {}),
        Box::new(super::cache::dcache::WriteBackLD {}),
        Box::new(super::cache::dcache::WriteBackSB {}),
        Box::new(super::cache::dcache::WriteBackSH {}),
        ...
        Box::new(super::cache::dcache::DataCacheHitWriteBack {}),
        Box::new(super::cache::dcache::DataCacheHitInvalidate {}),
        Box::new(super::cache::dcache::DataCacheIndexWriteBackInvalidate {}),
        Box::new(super::cache::dcache::DataCacheCreateDirtyExclusive {}),
        Box::new(super::cache::dcache::WriteCacheLineManuallyInvalid {}),
        Box::new(super::cache::dcache::WriteCacheLineManuallyClean {}),
        Box::new(super::cache::dcache::WriteCacheLineManuallyDirty {}),
        ...
        Box::new(super::cache::dcache::CacheLineIndexPtagConflict {}),
        Box::new(super::cache::icache::ModifyCached {}),
        Box::new(super::cache::icache::ModifyCached2 {}),
        Box::new(super::cache::icache::ModifyWithinBasicBlockUncachedWrite {}),
        Box::new(super::cache::icache::ModifyWithinBasicBlockUncachedWriteCycle {}),
        Box::new(super::cache::icache::ModifyTargetOfBranch {}),
        Box::new(super::cache::icache::ModifyTargetOfBranchFromDelaySlot {}),
        Box::new(super::cache::icache::ModifyTargetOfBranchFromDelaySlotCycle {}),
        Box::new(super::cache::icache::ModifyWithinBasicBlockExplicitDCacheHitWriteBack {}),
        Box::new(super::cache::icache::ModifyWithinBasicBlockExplicitDCacheHitWriteBackCycle {}),
        Box::new(super::cache::icache::ModifyWithinBasicBlockImplicitDCacheWriteBackLW {}),
        Box::new(super::cache::icache::ModifyWithinBasicBlockImplicitDCacheWriteBackSW {}),
        Box::new(super::cache::icache::ModifyWithinBasicBlockImplicitDCacheWriteBackSWL {}),
        Box::new(super::cache::icache::ModifyWithinBasicBlockImplicitDCacheWriteBackCycle {}),
        Box::new(super::cache::icache::ModifyWithinBasicBlockICacheInvalidate {}),
        Box::new(super::cache::icache::ModifyWithinBasicBlockICacheInvalidateCycle {}),
        Box::new(super::cache::icache::ModifyWithinBasicBlockMultipleSW {}),
        Box::new(super::cache::icache::InstructionCacheIndexInvalidate {}),
        Box::new(super::cache::icache::InstructionCacheHitInvalidate {}),
        Box::new(super::cache::icache::InstructionCacheFill {}),
        Box::new(super::cache::icache::InstructionCacheIndexStoreTag {}),
        Box::new(super::cache::icache::InstructionCacheHitWriteBack {}),
        ...
        Box::new(super::cop0::TagLoMasking),
        Box::new(super::cop0::TagHiMasking),
        Box::new(super::cop0::CacheErrMasking),
        Box::new(super::cop0::PErrMasking),
        ...
        Box::new(super::cop0::compare::CompareInterruptSignalling {}),
        Box::new(super::cop0::compare::CompareInterruptSignalling2 {}),
        Box::new(super::cop0::compare::CompareInterruptsPast {}),
        ...
        Box::new(super::exception_instructions::reserved::ReservedCOP0FunctionsAreNops {}),
        Box::new(super::exception_instructions::reserved::ReservedEncodingsRaiseRI {}),
        Box::new(super::exception_instructions::reserved::COP0RecognisedSubOpcodesDoNotTrap {}),
        Box::new(super::exception_instructions::reserved::COP1ReservedEncodingsAreUnimplemented {}),
        Box::new(super::exception_instructions::reserved::COP1UnusableTakesPrecedence {}),
        Box::new(super::exception_instructions::reserved::COOperandBitsTLBRExecutes {}),
        Box::new(super::exception_instructions::reserved::COOperandBitsTLBPExecutes {}),
        Box::new(super::exception_instructions::reserved::COOperandBitsERETExecutes {}),
        Box::new(super::exception_instructions::reserved::COOperandBitsRFETraps {}),
        Box::new(super::exception_instructions::reserved::COOperandBitsReservedStayNops {}),
        Box::new(super::exception_instructions::SoftwareInterrupt1Enabled {}),
        Box::new(super::exception_instructions::SoftwareInterrupt1EnabledHazard {}),
        Box::new(super::exception_instructions::SoftwareInterrupt1Masked {}),
        Box::new(super::exception_instructions::SoftwareInterrupt1InterruptsDisabled {}),
        Box::new(super::exception_instructions::SoftwareInterrupt2Enabled {}),
        Box::new(super::exception_instructions::SoftwareInterrupt2Masked {}),
        Box::new(super::exception_instructions::SoftwareInterrupt2InterruptsDisabled {}),
        Box::new(super::exception_instructions::SoftwareInterrupt12Enabled {}),
        Box::new(super::exception_instructions::SoftwareInterrupt12Enabled {}),
        Box::new(super::exception_instructions::SoftwareInterrupt1EnableAndDisableInstantly {}),
        Box::new(super::exception_instructions::SoftwareInterrupt1EnableAndDisableAfterOneNop {}),
        ...
        Box::new(super::jumps::jr_and_jalr::JRSimple {}),
        ...
        Box::new(super::timing::HiLoInterlockTiming {}),
        Box::new(super::timing::Exceptions {}),
        Box::new(super::timing::CachedLoadsAndStoreTiming {}),
        Box::new(super::timing::COP1Instructions32 {}),
        Box::new(super::timing::COP1Instructions64 {}),
        Box::new(super::timing::UncachedWriteBufferTest {}),
        ...
        Box::new(super::rdp::soft_differential::SoftFillTriangle {}),
        Box::new(super::rdp::soft_differential::SoftFillTriangleCoverage32 {}),
        Box::new(super::rdp::soft_differential::SoftShadeTriangle32 {}),
        Box::new(super::rdp::soft_differential::SoftLoadTileRgba16 {}),
        ...
        Box::new(super::rsp_timing::ClockIsMasked {}),
        Box::new(super::rsp_timing::CyclesSLL {}),
