...
fn default_tests() -> Vec<Box<dyn Test>> {
    vec! {
        ...
        Box::new(super::cache::ReadCachedVsUncached {}),
        Box::new(super::cache::WriteBackLB {}),
        Box::new(super::cache::WriteBackLBU {}),
        Box::new(super::cache::WriteBackLH {}),
        Box::new(super::cache::WriteBackLHU {}),
        Box::new(super::cache::WriteBackLW {}),
        Box::new(super::cache::WriteBackLWU {}),
        Box::new(super::cache::WriteBackLD {}),
        Box::new(super::cache::WriteBackSB {}),
        Box::new(super::cache::WriteBackSH {}),
        Box::new(super::cache::WriteBackSW {}),
        Box::new(super::cache::WriteBackSD {}),
        Box::new(super::cache::WriteBackCacheDataIndexWriteBackInvalidate {}),
        Box::new(super::cache::WriteBackCacheDataIndexWriteBackInvalidateUncachedAddress {}),
        Box::new(super::cache::WriteBackCacheDataIndexWriteBackInvalidateNextBlock {}),
        Box::new(super::cache::DataCacheIndexLoadTag {}),
        Box::new(super::cache::DataCacheHitWriteBackInvalidate {}),
        Box::new(super::cache::DataCacheHitWriteBack {}),
        Box::new(super::cache::DataCacheHitInvalidate {}),
        Box::new(super::cache::DataCacheIndexWriteBackInvalidate {}),
        Box::new(super::cache::DataCacheCreateDirtyExclusive {}),
        Box::new(super::cache::WriteCacheLineManuallyInvalid {}),
        Box::new(super::cache::WriteCacheLineManuallyClean {}),
        Box::new(super::cache::WriteCacheLineManuallyDirty {}),
        Box::new(super::cache::WriteCacheLineManually01 {}),
        Box::new(super::cache::MoveCacheLine {}),
        Box::new(super::cache::UnusedBitsInCacheReadWrite {}),
        Box::new(super::cache::HitInvalidateKeepsDirtyFlag {}),
