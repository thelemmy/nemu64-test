...
fn default_tests() -> Vec<Box<dyn Test>> {
    vec![
        ...
        Box::new(super::arithmetic::i64_codegen::I64EdgeWalk {}),
        Box::new(super::arithmetic::i64_codegen::StackPointerIs8ByteAligned {}),
        Box::new(super::arithmetic::i64_codegen::I64WalkAndPaint {}),
