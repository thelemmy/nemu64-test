...
use crate::cop1::{cfc1, ctc1, fcsr, set_fcsr, FCSRFlags, FCSRRoundingMode, FConst, FCSR};
use crate::exception_handler::expect_exception;
use crate::tests::soft_asserts::{
    soft_assert_eq, soft_assert_eq2, soft_assert_f32_bits, soft_assert_f64_bits,
};
...
const fn expected_unimplemented_f32() -> Result<(FCSRFlags, f32), ()> {
    Err(())
}
const fn expected_unimplemented_f64() -> Result<(FCSRFlags, f64), ()> {
    Err(())
}
const fn expected_unimplemented_i32() -> Result<(FCSRFlags, i32), ()> {
    Err(())
}
const fn expected_unimplemented_i64() -> Result<(FCSRFlags, i64), ()> {
    Err(())
}
...
impl Test for CFC1CTC1_31 {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        ...
        for v in [
            0,
            0b1111111_11_11111_0_11111_00000_11111_11,
            0b1111111_11_11111_0_00000_11111_00000_11,
            0,
        ] {
            ...
            soft_assert_eq(
                ...
                fcsr().raw_value(),
                format!(
                    "CFC1 31 (after writing {:x}). You might need to apply mask 0x{:x}",
                    v, MASK
                )
                .as_str(),
            )?;
...
impl Test for FireExceptionViaCTC1 {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        ...
        soft_assert_eq(
            ...
            Assembler::make_ctc1(GPR::V0, u5::new(31)),
            "ExceptPC points to wrong instruction",
        )?;
        soft_assert_eq(
            exception_context.cause,
            Cause::DEFAULT.with_exception(CauseException::FPE),
            "Cause",
        )?;
        soft_assert_eq(
            exception_context.status,
            Status::DEFAULT.with_exl(true).raw_value(),
            "Status",
        )?;
        soft_assert_eq(
...
impl Test for FireUnimplementedExceptionViaCTC1 {
    fn name(&self) -> &str {
        "Fire unimplemented exception through CTC1"
    }
...
1:
        ...
        soft_assert_eq(
            exception_context.fcsr,
            FCSR::ZERO.with_cause_unimplemented_operation(true),
            "FCSR",
        )?;
        Ok(())
    }
...
impl Test for FireExceptionViaCTC1FollowedByMFC1 {
    fn name(&self) -> &str {
        "Fire exception through CTC1 (followed by MFC1)"
    }
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        ...
        soft_assert_eq(
            exception_context.cause,
            Cause::DEFAULT
                .with_exception(CauseException::FPE)
                .with_coprocessor_error(u2::new(1)),
            "Cause",
        )?;
        soft_assert_eq(
            exception_context.status,
...
impl Test for FireExceptionViaCTC1FollowedByMFC2 {
    fn name(&self) -> &str {
        "Fire exception through CTC1 (followed by MFC2)"
    }
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        preset_cause_to_copindex2()?;
        unsafe {
            set_status(Status::DEFAULT.with_cop2usable(true));
        }
        ...
        soft_assert_eq(
            ...
            Cause::DEFAULT
                .with_exception(CauseException::FPE)
                .with_coprocessor_error(u2::new(2)),
            "Cause",
        )?;
        soft_assert_eq(
            exception_context.status,
            Status::DEFAULT
                .with_cop2usable(true)
                .with_exl(true)
                .raw_value(),
            "Status",
        )?;
...
impl Test for FireExceptionViaCTC1Delay {
    fn name(&self) -> &str {
        "Fire exception through CTC1 (delay)"
    }
...
fn asm_block_f32<const BRANCH_INSTRUCTION: u32, const INSTRUCTION: u32>(
    value1: f32,
    value2: f32,
) -> f32 {
    let result: f32;
...
fn asm_block_f32tof64<const BRANCH_INSTRUCTION: u32, const INSTRUCTION: u32>(
    value1: f32,
    value2: f32,
) -> f64 {
    let result: f64;
...
fn asm_block_f32toi32<const BRANCH_INSTRUCTION: u32, const INSTRUCTION: u32>(
    value1: f32,
    value2: f32,
) -> i32 {
...
fn asm_block_f64tof32<const BRANCH_INSTRUCTION: u32, const INSTRUCTION: u32>(
    value1: f64,
    value2: f64,
) -> f32 {
    let result: f32;
...
fn asm_block_f64toi32<const BRANCH_INSTRUCTION: u32, const INSTRUCTION: u32>(
    value1: f64,
    value2: f64,
) -> i32 {
    let mut result: f32 = f32::from_bits(i32::cast_unsigned(TARGET_REG_DEFAULT_I32));
...
fn asm_block_i32toi32<const BRANCH_INSTRUCTION: u32, const INSTRUCTION: u32>(
    value1: i32,
    value2: i32,
) -> i32 {
    let mut result: f32 = f32::from_bits(i32::cast_unsigned(TARGET_REG_DEFAULT_I32));
...
fn asm_block_i64tof32<const BRANCH_INSTRUCTION: u32, const INSTRUCTION: u32>(
    value1: i64,
    value2: i64,
) -> f32 {
    let result: f32;
...
fn asm_block_i64tof64<const BRANCH_INSTRUCTION: u32, const INSTRUCTION: u32>(
    value1: i64,
    value2: i64,
) -> f64 {
    let result: f64;
...
fn asm_block_i64toi32<const BRANCH_INSTRUCTION: u32, const INSTRUCTION: u32>(
    value1: i64,
    value2: i64,
) -> i32 {
    let mut result: f32 = f32::from_bits(i32::cast_unsigned(TARGET_REG_DEFAULT_I32));
...
fn test_floating_point<FIn: Copy, FOut: Copy>(
    ...
    value1: FIn,
    value2: FIn,
    expected: Result<(FCSRFlags, FOut), ()>,
) -> Result<(), String> {
            ...
            for causes_set_before in [FCSRFlags::NONE, enabled.invert()] {
                set_fcsr(
                    FCSR::ZERO
                        ...
                        .with_maskable_causes(causes_set_before),
                );
                let regular_result = f(value1, value2);
                let regular_result_fcsr = fcsr();
                let expected_cause_bits = if expected_clear_cause_bits {
                    expected_flags
                } else {
                    expected_flags | causes_set_before
                };
                ...
                assert_f_equal(
                    regular_result,
                    expected_result,
                    format!("Result after {}", context).as_str(),
                )?;
                soft_assert_eq2(regular_result_fcsr, expected_fcsr_no_exception, || {
                    format!("FCSR after {} with exceptions disabled", context)
                })?;
            }
        }
    ...
    let enables_and_expected_causes = if let Ok((expected_flags, _)) = expected {
                ...
                .with_inexact_operation(true)
        {
            vec![
                ...
                (
                    FCSRFlags::DEFAULT.with_underflow(true),
                    FCSR::ZERO.with_cause_unimplemented_operation(true),
                ),
                (
                    FCSRFlags::DEFAULT.with_inexact_operation(true),
                    FCSR::ZERO.with_cause_unimplemented_operation(true),
                ),
            ]
        } else {
            ...
            vec![
                (
                    FCSRFlags::ALL,
                    FCSR::ZERO.with_maskable_causes(expected_flags),
                ),
                (
                    expected_flags,
                    FCSR::ZERO.with_maskable_causes(expected_flags),
    ...
    for (enable, expected_cause) in enables_and_expected_causes {
        for is_delay in [false, true] {
            ...
            let exception_context =
                expect_exception(CauseException::FPE, if is_delay { 2 } else { 1 }, || {
            ...
            soft_assert_eq(
                unsafe {
                    *(exception_context.exceptpc as *const u32).add(if is_delay { 1 } else { 0 })
                },
                instruction,
                "ExceptPC points to wrong instruction",
            )?;
            soft_assert_eq(
                exception_context.cause,
                Cause::DEFAULT
                    .with_coprocessor_error(u2::new(0))
                    .with_exception(CauseException::FPE)
                    .with_branch_delay(is_delay),
                "Cause",
            )?;
            soft_assert_eq(exception_context.status, 0x24000002, "Status")?;
            let expected_fcsr_with_all_enabled = expected_cause
                .with_rounding_mode(rounding_mode)
                .with_flush_denorm_to_zero(flush_denorm_to_zero)
                .with_enables(enable);
            soft_assert_eq(
                exception_context.fcsr,
                expected_fcsr_with_all_enabled,
                "FCSR after operation with exceptions enabled",
            )?;
            assert_f_equal(
                expection_result,
                default,
                "Result after operation (with exception)",
            )?;
        }
    }
...
fn test_floating_point_f32_which_preserves_cause_bits<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: f32,
    value2: f32,
    expected: Result<(FCSRFlags, f32), ()>,
) -> Result<(), String> {
...
fn test_floating_point_f32<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: f32,
...
fn test_floating_point_f32tof64<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: f32,
    value2: f32,
    expected: Result<(FCSRFlags, f64), ()>,
) -> Result<(), String> {
    const BEQ_INSTRUCTION: u32 = Assembler::make_beq(GPR::R0, GPR::R0, 1);
...
fn test_floating_point_f32toi32<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: f32,
    value2: f32,
    expected: Result<(FCSRFlags, i32), ()>,
) -> Result<(), String> {
    const BEQ_INSTRUCTION: u32 = Assembler::make_beq(GPR::R0, GPR::R0, 1);
...
fn test_floating_point_f32toi64<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: f32,
    value2: f32,
    expected: Result<(FCSRFlags, i64), ()>,
) -> Result<(), String> {
    const BEQ_INSTRUCTION: u32 = Assembler::make_beq(GPR::R0, GPR::R0, 1);
...
fn test_floating_point_f64_which_preserves_cause_bits<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: f64,
...
fn test_floating_point_f64<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: f64,
...
fn test_floating_point_f64tof32<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: f64,
...
fn test_floating_point_f64toi32<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: f64,
...
fn test_floating_point_f64toi64<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: f64,
...
fn test_floating_point_i32tof32<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: i32,
...
fn test_floating_point_i32toi32<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: i32,
...
fn test_floating_point_i32toi64<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: i32,
...
fn test_floating_point_i32tof64<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: i32,
...
fn test_floating_point_i64tof32<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: i64,
...
fn test_floating_point_i64tof64<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: i64,
...
fn test_floating_point_i64toi32<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: i64,
...
fn test_floating_point_i64toi64<const INSTRUCTION: u32>(
    context: &str,
    flush_denorm_to_zero: bool,
    rounding_mode: FCSRRoundingMode,
    value1: i64,
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(
            ...
            (
                ...
                f32::MIN,
                -1f32,
                expected_result(FCSRFlags::DEFAULT, f32::MAX),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                f32::MIN_POSITIVE,
                -1f32,
                expected_result(FCSRFlags::DEFAULT, -f32::MIN_POSITIVE),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                f32::MAX,
                -1f32,
                expected_result(FCSRFlags::DEFAULT, f32::MIN),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                1f32,
                10f32,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 0.1f32),
            ),
            (
                false,
            ...
            (
                false,
                FCSRRoundingMode::NegativeInfinity,
                1f32,
                10f32,
                expected_result(
                    FCSRFlags::DEFAULT.with_inexact_operation(true),
            ...
            (
                false,
                FCSRRoundingMode::PositiveInfinity,
                1f32,
                10f32,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 0.1f32),
            ),
            ...
            (
                ...
                0f32,
                expected_result(
                    FCSRFlags::DEFAULT.with_division_by_zero(true),
                    f32::INFINITY,
                ),
            ),
            (
            ...
            (
                ...
                f32::INFINITY,
                -0.5f32,
                expected_result(FCSRFlags::DEFAULT, f32::NEG_INFINITY),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
        ...
        crate::tests::boxed_values(VALUES_0)
    }
    ...
    fn run(&self, value: &Box<dyn Any>) -> Result<(), String> {
        ...
        match (*value).downcast_ref::<(
            ...
            Some((flush_denorm_to_zero, rounding_mode, value1, value2, expected)) => {
                test_floating_point_f32::<INSTRUCTION>(
                    "DIV.S",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
...
impl Test for DivD {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(
            ...
            (
                ...
                f64::MIN,
                -1f64,
                expected_result(FCSRFlags::DEFAULT, f64::MAX),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                f64::MIN_POSITIVE,
                -1f64,
                expected_result(FCSRFlags::DEFAULT, -f64::MIN_POSITIVE),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                f64::MAX,
                -1f64,
                expected_result(FCSRFlags::DEFAULT, f64::MIN),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                1f64,
                10f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 0.1f64),
            ),
            (
                false,
                FCSRRoundingMode::Zero,
            ...
            (
                true,
                FCSRRoundingMode::Nearest,
                FConst::SUBNORMAL_MIN_NEGATIVE_64,
                1f64,
                expected_unimplemented_f64(),
            ),
            (
                true,
                FCSRRoundingMode::Nearest,
                FConst::SUBNORMAL_MAX_NEGATIVE_64,
                1f64,
                expected_unimplemented_f64(),
            ),
            (
    ...
    fn run(&self, value: &Box<dyn Any>) -> Result<(), String> {
        ...
        match (*value).downcast_ref::<(
            ...
            Some((flush_denorm_to_zero, rounding_mode, value1, value2, expected)) => {
                test_floating_point_f64::<INSTRUCTION>(
                    "DIV.D",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(
            ...
            (
                ...
                0.456789123f32,
                10.123457095f32,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 4.624285f32),
            ),
            (
                false,
                FCSRRoundingMode::NegativeInfinity,
            ...
            (
                ...
                f32::MAX,
                f32::MIN_POSITIVE,
                expected_result(FCSRFlags::DEFAULT, 3.9999998f32),
            ),
            (
                false,
                FCSRRoundingMode::PositiveInfinity,
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(
            ...
            (
                ...
                f64::MAX,
                f64::MIN_POSITIVE,
                expected_result(FCSRFlags::DEFAULT, 3.9999999999999996f64),
            ),
            (
                false,
                FCSRRoundingMode::PositiveInfinity,
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(
            ...
            (
                ...
                0f32,
                2f32,
                expected_result(FCSRFlags::DEFAULT, 2f32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                1f32,
                5f32,
                expected_result(FCSRFlags::DEFAULT, 6f32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                f32::MIN,
                -1f32,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), f32::MIN),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                f32::MAX,
                -1f32,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), f32::MAX),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(
            ...
            (
                ...
                0f64,
                2f64,
                expected_result(FCSRFlags::DEFAULT, 2f64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                1f64,
                5f64,
                expected_result(FCSRFlags::DEFAULT, 6f64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                f64::MIN,
                -1f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), f64::MIN),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                f64::MAX,
                -1f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), f64::MAX),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
...
impl Test for AbsS {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(bool, FCSRRoundingMode, f32, Result<(FCSRFlags, f32), ()>)] = &[
            (
                false,
                FCSRRoundingMode::Nearest,
                0f32,
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                1f32,
                expected_result(FCSRFlags::DEFAULT, 1f32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
...
impl Test for AbsD {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(bool, FCSRRoundingMode, f64, Result<(FCSRFlags, f64), ()>)] = &[
            (
                false,
                FCSRRoundingMode::Nearest,
                0f64,
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                1f64,
                expected_result(FCSRFlags::DEFAULT, 1f64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
...
impl Test for MovS {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        vec![
            ...
            Box::new((
                ...
                FCSRRoundingMode::Nearest,
                FConst::SUBNORMAL_MIN_POSITIVE_32,
                expected_result(FCSRFlags::DEFAULT, FConst::SUBNORMAL_MIN_POSITIVE_32),
            )),
            Box::new((
                true,
                FCSRRoundingMode::Nearest,
    ...
    fn run(&self, value: &Box<dyn Any>) -> Result<(), String> {
        ...
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                test_floating_point_f32_which_preserves_cause_bits::<INSTRUCTION>(
                    "MOV.S",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
...
impl Test for MovD {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        vec![
            ...
            Box::new((
                ...
                FCSRRoundingMode::Nearest,
                FConst::SUBNORMAL_MIN_POSITIVE_64,
                expected_result(FCSRFlags::DEFAULT, FConst::SUBNORMAL_MIN_POSITIVE_64),
            )),
            Box::new((
                true,
                FCSRRoundingMode::Nearest,
    ...
    fn run(&self, value: &Box<dyn Any>) -> Result<(), String> {
        ...
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                test_floating_point_f64_which_preserves_cause_bits::<INSTRUCTION>(
                    "MOV.D",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(bool, FCSRRoundingMode, f32, Result<(FCSRFlags, f32), ()>)] = &[
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                f32::MIN_POSITIVE,
                expected_result(FCSRFlags::DEFAULT, 1.0842022e-19f32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
            ...
            (
                false,
                FCSRRoundingMode::Nearest,
                0.0000000000000000000000106731965f32,
                expected_result(
                    FCSRFlags::DEFAULT.with_inexact_operation(true),
                    3.2669859e-12f32,
                ),
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(bool, FCSRRoundingMode, f64, Result<(FCSRFlags, f64), ()>)] = &[
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                f64::MIN_POSITIVE,
                expected_result(FCSRFlags::DEFAULT, 1.4916681462400413e-154f64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
...
impl Test for CvtS {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(bool, FCSRRoundingMode, i32, Result<(FCSRFlags, f32), ()>)] = &[
            // W => S
            (
                false,
                FCSRRoundingMode::Nearest,
                9i32,
                expected_result(FCSRFlags::DEFAULT, 9f32),
            ),
            (
                false,
                FCSRRoundingMode::Zero,
            ...
            (
                ...
                expected_result(FCSRFlags::DEFAULT, -2147483600f32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                0xFFFFFFFDu32 as i32,
                expected_result(FCSRFlags::DEFAULT, -3f32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
        ...
        const VALUES_1: &[(bool, FCSRRoundingMode, i64, Result<(FCSRFlags, f32), ()>)] = &[
            // L => S
            (
                false,
                FCSRRoundingMode::Nearest,
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                1i64 << 53,
                expected_result(FCSRFlags::DEFAULT, 9007199000000000f32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                1i64 << 54,
                expected_result(FCSRFlags::DEFAULT, 1.8014399e16f32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                -(1i64 << 55),
                expected_result(FCSRFlags::DEFAULT, -3.6028797e16f32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
        ...
        const VALUES_2: &[(bool, FCSRRoundingMode, f64, Result<(FCSRFlags, f32), ()>)] = &[
            // D => S
            (
                false,
                FCSRRoundingMode::Nearest,
                4f64,
                expected_result(FCSRFlags::DEFAULT, 4f32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
            ...
            (
                false,
                FCSRRoundingMode::Nearest,
                4.123456789123456f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 4.123457f32),
            ),
            (
                false,
                FCSRRoundingMode::Zero,
        ...
        const VALUES_3: &[(bool, FCSRRoundingMode, f32, Result<(FCSRFlags, f32), ()>)] = &[
        ...
        let mut result = crate::tests::boxed_values(VALUES_0);
        result.extend(crate::tests::boxed_values(VALUES_1));
        result.extend(crate::tests::boxed_values(VALUES_2));
        result.extend(crate::tests::boxed_values(VALUES_3));
        result
    }
    ...
    fn run(&self, value: &Box<dyn Any>) -> Result<(), String> {
        ...
        match (*value).downcast_ref::<(bool, FCSRRoundingMode, f64, Result<(FCSRFlags, f32), ()>)>()
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                ...
                test_floating_point_f64tof32::<INSTRUCTION>(
                    "CVT.S.D",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
        ...
        match (*value).downcast_ref::<(bool, FCSRRoundingMode, i32, Result<(FCSRFlags, f32), ()>)>()
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                ...
                test_floating_point_i32tof32::<INSTRUCTION>(
                    "CVT.S.W",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
        ...
        match (*value).downcast_ref::<(bool, FCSRRoundingMode, i64, Result<(FCSRFlags, f32), ()>)>()
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                ...
                test_floating_point_i64tof32::<INSTRUCTION>(
                    "CVT.S.L",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
...
impl Test for CvtD {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(bool, FCSRRoundingMode, i32, Result<(FCSRFlags, f64), ()>)] = &[
            // W => D
            (
                false,
                FCSRRoundingMode::Nearest,
                9i32,
                expected_result(FCSRFlags::DEFAULT, 9f64),
            ),
            (
                false,
                FCSRRoundingMode::Zero,
                1234567891i32,
                expected_result(FCSRFlags::DEFAULT, 1234567891f64),
            ),
            (
                false,
                FCSRRoundingMode::Zero,
            ...
            (
                ...
                FCSRRoundingMode::NegativeInfinity,
                i32::MAX,
                expected_result(FCSRFlags::DEFAULT, 2147483647f64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
        ...
        const VALUES_1: &[(bool, FCSRRoundingMode, i64, Result<(FCSRFlags, f64), ()>)] = &[
            // L => D
            (
                false,
                FCSRRoundingMode::Nearest,
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                1i64 << 53,
                expected_result(FCSRFlags::DEFAULT, 9007199254740992f64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                1i64 << 54,
                expected_result(FCSRFlags::DEFAULT, 1.8014398509481984e16f64),
            ),
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                (1i64 << 55) - 4,
                expected_result(FCSRFlags::DEFAULT, 3.6028797018963964e16f64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                -(1i64 << 55),
                expected_result(FCSRFlags::DEFAULT, -3.602879701896397e16f64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
        ...
        const VALUES_2: &[(bool, FCSRRoundingMode, f64, Result<(FCSRFlags, f64), ()>)] = &[
        ...
        const VALUES_3: &[(bool, FCSRRoundingMode, f32, Result<(FCSRFlags, f64), ()>)] = &[
            // S ==> D
            (
                false,
                FCSRRoundingMode::Nearest,
                4f32,
                expected_result(FCSRFlags::DEFAULT, 4f64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                f32::MIN_POSITIVE,
                expected_result(FCSRFlags::DEFAULT, 1.1754943508222875e-38),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
    ...
    fn run(&self, value: &Box<dyn Any>) -> Result<(), String> {
        match (*value).downcast_ref::<(bool, FCSRRoundingMode, f32, Result<(FCSRFlags, f64), ()>)>()
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                ...
                test_floating_point_f32tof64::<INSTRUCTION>(
                    "CVT.D.S",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
        ...
        match (*value).downcast_ref::<(bool, FCSRRoundingMode, i32, Result<(FCSRFlags, f64), ()>)>()
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                ...
                test_floating_point_i32tof64::<INSTRUCTION>(
                    "CVT.D.W",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
        ...
        match (*value).downcast_ref::<(bool, FCSRRoundingMode, i64, Result<(FCSRFlags, f64), ()>)>()
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                ...
                test_floating_point_i64tof64::<INSTRUCTION>(
                    "CVT.D.L",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
...
impl Test for ConvertToW {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(bool, FCSRRoundingMode, f64, Result<(FCSRFlags, i32), ()>)] = &[
            (
                false,
                FCSRRoundingMode::Nearest,
                4.5f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 4i32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                5.5f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 6i32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                7.5f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 8i32),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
            ...
            (
                ...
                FCSRRoundingMode::PositiveInfinity,
                4.4f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 5i32),
            ),
            (
                false,
                FCSRRoundingMode::NegativeInfinity,
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                f64::MIN_POSITIVE,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 0i32),
            ),
            (
                false,
                FCSRRoundingMode::Zero,
            ...
            (
                ...
                FCSRRoundingMode::PositiveInfinity,
                f64::MIN_POSITIVE,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 1i32),
            ),
            (
                false,
                FCSRRoundingMode::NegativeInfinity,
        ...
        const VALUES_1: &[(bool, FCSRRoundingMode, f32, Result<(FCSRFlags, i32), ()>)] = &[
            (
                false,
                FCSRRoundingMode::Nearest,
                4.5f32,
        ...
        const VALUES_2: &[(i32, Result<(FCSRFlags, i32), ()>)] = &[
            // W => W (which doesn't exist)
            (4i32, expected_unimplemented_i32()),
        ];
        const VALUES_3: &[(i64, Result<(FCSRFlags, i32), ()>)] = &[
            // L => W (which doesn't exist)
            (4i64, expected_unimplemented_i32()),
        ];
        const VALUES_4: &[(f64, Result<(FCSRFlags, i32), ()>)] = &[
            // D => W
            (4f64, expected_result(FCSRFlags::DEFAULT, 4i32)),
            (
                2147483500f64,
                expected_result(FCSRFlags::DEFAULT, 2147483500i32),
            ),
            (
                2147483647f64,
                expected_result(FCSRFlags::DEFAULT, 2147483647i32),
            ),
            (2147483648f64, expected_unimplemented_i32()),
            ...
            (
                -2147483648f64,
                expected_result(FCSRFlags::DEFAULT, -2147483648i32),
            ),
            (-2147483649f64, expected_unimplemented_i32()),
        ...
        const VALUES_5: &[(f32, Result<(FCSRFlags, i32), ()>)] = &[
            // S ==> W
            (4f32, expected_result(FCSRFlags::DEFAULT, 4i32)),
            (
                2140000000f32,
                expected_result(FCSRFlags::DEFAULT, 2140000000i32),
            ),
            (
                2147483520f32,
                expected_result(FCSRFlags::DEFAULT, 2147483520i32),
            ),
            (2147483600f32, expected_unimplemented_i32()),
            ...
            (-2147483904f32, expected_unimplemented_i32()),
            (-2150000000f32, expected_unimplemented_i32()),
        ...
        result.extend(crate::tests::boxed_values(VALUES_2));
        result.extend(crate::tests::boxed_values(VALUES_3));
        result.extend(crate::tests::boxed_values(VALUES_4));
        result.extend(crate::tests::boxed_values(VALUES_5));
        result
    }
    ...
    fn run(&self, value: &Box<dyn Any>) -> Result<(), String> {
        match (*value).downcast_ref::<(bool, FCSRRoundingMode, f32, Result<(FCSRFlags, i32), ()>)>()
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                ...
                test_floating_point_f32toi32::<INSTRUCTION>(
                    "CVT.W.S",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
                ...
                for dummy_rounding_mode in [
                    FCSRRoundingMode::PositiveInfinity,
                    FCSRRoundingMode::NegativeInfinity,
                ] {
                    match *rounding_mode {
                        FCSRRoundingMode::Nearest => {
                            test_floating_point_f32toi32::<ROUND_INSTRUCTION>(
                                "ROUND.W.S",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::Zero => {
                            test_floating_point_f32toi32::<TRUNC_INSTRUCTION>(
                                "TRUNC.W.S",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::PositiveInfinity => {
                            test_floating_point_f32toi32::<CEIL_INSTRUCTION>(
                                "CEIL.W.S",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::NegativeInfinity => {
                            test_floating_point_f32toi32::<FLOOR_INSTRUCTION>(
                                "FLOOR.W.S",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
        ...
        match (*value).downcast_ref::<(bool, FCSRRoundingMode, f64, Result<(FCSRFlags, i32), ()>)>()
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                ...
                test_floating_point_f64toi32::<INSTRUCTION>(
                    "CVT.W.D",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
                ...
                for dummy_rounding_mode in [
                    ...
                    match *rounding_mode {
                        FCSRRoundingMode::Nearest => {
                            test_floating_point_f64toi32::<ROUND_INSTRUCTION>(
                                "ROUND.W.D",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::Zero => {
                            test_floating_point_f64toi32::<TRUNC_INSTRUCTION>(
                                "TRUNC.W.D",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::PositiveInfinity => {
                            test_floating_point_f64toi32::<CEIL_INSTRUCTION>(
                                "CEIL.W.D",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::NegativeInfinity => {
                            test_floating_point_f64toi32::<FLOOR_INSTRUCTION>(
                                "FLOOR.W.D",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
        ...
        match (*value).downcast_ref::<(i32, Result<(FCSRFlags, i32), ()>)>() {
            Some((value1, expected)) => {
                for rounding_mode in FCSRRoundingMode::ALL {
                    ...
                    test_floating_point_i32toi32::<INSTRUCTION>(
                        "CVT.W.W",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i32toi32::<INSTRUCTION2>(
                        "ROUND.W.W",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i32toi32::<INSTRUCTION3>(
                        "TRUNC.W.W",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i32toi32::<INSTRUCTION4>(
                        "CEIL.W.W",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i32toi32::<INSTRUCTION5>(
                        "FLOOR.W.W",
                        false,
                        rounding_mode,
                        *value1,
        ...
        match (*value).downcast_ref::<(i64, Result<(FCSRFlags, i32), ()>)>() {
            Some((value1, expected)) => {
                for rounding_mode in FCSRRoundingMode::ALL {
                    ...
                    test_floating_point_i64toi32::<INSTRUCTION>(
                        "CVT.W.L",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i64toi32::<INSTRUCTION2>(
                        "ROUND.W.L",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i64toi32::<INSTRUCTION3>(
                        "TRUNC.W.L",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i64toi32::<INSTRUCTION4>(
                        "CEIL.W.L",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i64toi32::<INSTRUCTION5>(
                        "FLOOR.W.L",
                        false,
                        rounding_mode,
                        *value1,
...
impl Test for ConvertToL {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        const VALUES_0: &[(bool, FCSRRoundingMode, f64, Result<(FCSRFlags, i64), ()>)] = &[
            (
                false,
                FCSRRoundingMode::Nearest,
                4.5f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 4i64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
                5.5f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 6i64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                7.5f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 8i64),
            ),
            (
                false,
                FCSRRoundingMode::Nearest,
            ...
            (
                ...
                FCSRRoundingMode::PositiveInfinity,
                4.4f64,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 5i64),
            ),
            (
                false,
                FCSRRoundingMode::NegativeInfinity,
            ...
            (
                ...
                FCSRRoundingMode::Nearest,
                f64::MIN_POSITIVE,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 0i64),
            ),
            (
                false,
                FCSRRoundingMode::Zero,
            ...
            (
                ...
                FCSRRoundingMode::PositiveInfinity,
                f64::MIN_POSITIVE,
                expected_result(FCSRFlags::DEFAULT.with_inexact_operation(true), 1i64),
            ),
            (
                false,
                FCSRRoundingMode::NegativeInfinity,
        ...
        const VALUES_1: &[(bool, FCSRRoundingMode, f32, Result<(FCSRFlags, i64), ()>)] = &[
            (
                false,
                FCSRRoundingMode::Nearest,
                4.5f32,
        ...
        const VALUES_2: &[(i32, Result<(FCSRFlags, i64), ()>)] = &[
            // W => L (which doesn't exist)
            (4i32, expected_unimplemented_i64()),
        ];
        const VALUES_3: &[(i64, Result<(FCSRFlags, i64), ()>)] = &[
            // L => L (which doesn't exist)
            (4i64, expected_unimplemented_i64()),
        ];
        const VALUES_4: &[(f64, Result<(FCSRFlags, i64), ()>)] = &[
            // D => L
            (4f64, expected_result(FCSRFlags::DEFAULT, 4i64)),
            (
                4e15f64,
                expected_result(FCSRFlags::DEFAULT, 4000000000000000i64),
            ),
            (
                8e15f64,
                expected_result(FCSRFlags::DEFAULT, 8000000000000000i64),
            ),
            (
                9e15f64,
                expected_result(FCSRFlags::DEFAULT, 9000000000000000i64),
            ),
            (
                9007199254740991f64,
                expected_result(FCSRFlags::DEFAULT, 9007199254740991i64),
            ),
            (9007199254740992f64, expected_unimplemented_i64()),
            (
                -9007199254740990f64,
                expected_result(FCSRFlags::DEFAULT, -9007199254740990i64),
            ),
            (
                -9007199254740991f64,
                expected_result(FCSRFlags::DEFAULT, -9007199254740991i64),
            ...
            (-9007199254740992f64, expected_unimplemented_i64()),
            (-9007199254740993f64, expected_unimplemented_i64()),
            (f64::MAX, expected_unimplemented_i64()),
        ...
        const VALUES_5: &[(f32, Result<(FCSRFlags, i64), ()>)] = &[
            (i64::MAX as f32 * 1024f32, expected_unimplemented_i64()),
            // S ==> L
            (4f32, expected_result(FCSRFlags::DEFAULT, 4i64)),
            (
                9.007198e15f32,
                expected_result(FCSRFlags::DEFAULT, 9007198180999168i64),
            ),
            (
                9.00719871787e15f32,
                expected_result(FCSRFlags::DEFAULT, 9007198717870080i64),
            ),
            (9.00719925474e15f32, expected_unimplemented_i64()),
            (9.00720032848e15f32, expected_unimplemented_i64()),
            (f32::MAX, expected_unimplemented_i64()),
            (
                -9.007198e15f32,
                expected_result(FCSRFlags::DEFAULT, -9007198180999168i64),
            ),
    ...
    fn run(&self, value: &Box<dyn Any>) -> Result<(), String> {
        match (*value).downcast_ref::<(bool, FCSRRoundingMode, f32, Result<(FCSRFlags, i64), ()>)>()
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                ...
                test_floating_point_f32toi64::<INSTRUCTION>(
                    "CVT.L.S",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
                ...
                for dummy_rounding_mode in [
                    ...
                    match *rounding_mode {
                        FCSRRoundingMode::Nearest => {
                            test_floating_point_f32toi64::<ROUND_INSTRUCTION>(
                                "ROUND.L.S",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::Zero => {
                            test_floating_point_f32toi64::<TRUNC_INSTRUCTION>(
                                "TRUNC.L.S",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::PositiveInfinity => {
                            test_floating_point_f32toi64::<CEIL_INSTRUCTION>(
                                "CEIL.L.S",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::NegativeInfinity => {
                            test_floating_point_f32toi64::<FLOOR_INSTRUCTION>(
                                "FLOOR.L.S",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
        ...
        match (*value).downcast_ref::<(bool, FCSRRoundingMode, f64, Result<(FCSRFlags, i64), ()>)>()
        {
            Some((flush_denorm_to_zero, rounding_mode, value1, expected)) => {
                ...
                test_floating_point_f64toi64::<INSTRUCTION>(
                    "CVT.L.D",
                    *flush_denorm_to_zero,
                    *rounding_mode,
                    *value1,
                ...
                for dummy_rounding_mode in [
                    ...
                    match *rounding_mode {
                        FCSRRoundingMode::Nearest => {
                            test_floating_point_f64toi64::<ROUND_INSTRUCTION>(
                                "ROUND.L.D",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::Zero => {
                            test_floating_point_f64toi64::<TRUNC_INSTRUCTION>(
                                "TRUNC.L.D",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::PositiveInfinity => {
                            test_floating_point_f64toi64::<CEIL_INSTRUCTION>(
                                "CEIL.L.D",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
                        ...
                        FCSRRoundingMode::NegativeInfinity => {
                            test_floating_point_f64toi64::<FLOOR_INSTRUCTION>(
                                "FLOOR.L.D",
                                *flush_denorm_to_zero,
                                dummy_rounding_mode,
                                *value1,
        ...
        match (*value).downcast_ref::<(i32, Result<(FCSRFlags, i64), ()>)>() {
            Some((value1, expected)) => {
                for rounding_mode in FCSRRoundingMode::ALL {
                    ...
                    test_floating_point_i32toi64::<INSTRUCTION>(
                        "CVT.L.W",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i32toi64::<INSTRUCTION2>(
                        "ROUND.L.W",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i32toi64::<INSTRUCTION3>(
                        "TRUNC.L.W",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i32toi64::<INSTRUCTION4>(
                        "CEIL.L.W",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i32toi64::<INSTRUCTION5>(
                        "FLOOR.L.W",
                        false,
                        rounding_mode,
                        *value1,
        ...
        match (*value).downcast_ref::<(i64, Result<(FCSRFlags, i64), ()>)>() {
            Some((value1, expected)) => {
                for rounding_mode in FCSRRoundingMode::ALL {
                    ...
                    test_floating_point_i64toi64::<INSTRUCTION>(
                        "CVT.L.L",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i64toi64::<INSTRUCTION2>(
                        "ROUND.L.L",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i64toi64::<INSTRUCTION3>(
                        "TRUNC.L.L",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i64toi64::<INSTRUCTION4>(
                        "CEIL.L.L",
                        false,
                        rounding_mode,
                        *value1,
                    ...
                    test_floating_point_i64toi64::<INSTRUCTION5>(
                        "FLOOR.L.L",
                        false,
                        rounding_mode,
                        *value1,
...
fn test_fcsr_unchanged<const INSTRUCTION: u32>() -> Result<(), String> {
    ...
    let fs = FCSR::ZERO
        ...
        .with_condition(true)
        .with_rounding_mode(FCSRRoundingMode::PositiveInfinity);
    set_fcsr(fs);
    unsafe {
        asm!("
        .WORD {INSTRUCTION}
