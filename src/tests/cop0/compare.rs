...
impl Test for CompareInterruptSignalling {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        ...
        // a good worst case, but 500 should be fine in practice
        ...
        match (*value).downcast_ref::<u32>() {
            Some(offset) => {
                ...
                unsafe {
                    asm!("
                        .set noreorder
                        .align 5 // Ensure the MFC to MTC are all within an icache line. Otherwise we risk missing the interrupt completely
                        ORI $7, $0, 1
0:
...
2:
                    ...
                    COMPARE = const RegisterIndex::Compare as usize,
