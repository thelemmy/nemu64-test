...
impl Test for ReBadVaddrUnmapped {
    fn name(&self) -> &str {
        "RE unmapped access keeps raw BadVAddr (no xor tweak)"
    }
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        ...
        for mode_64bit in [false, true] {
            for case in cases.iter() {
                ...
                soft_assert_eq2(context.badvaddr, address as u64, || {
                ...
                if xor_address != address as u64 {
                    soft_assert_neq(
                        ...
                        xor_address,
                        format!(
                            "BadVAddr for {} must not use xor-tweaked address",
                            case.name
                        )
                        .as_str(),
                    )?;
...
const SDL_EXPECTED: [[u64; 4]; 8] = [
    [
        0xaaaa_aaaa_aaaa_aa10,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0xaaaa_aaaa_aaaa_1020,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0xaaaa_aaaa_aa10_2030,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0xaaaa_aaaa_1020_3040,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0xaaaa_aa10_2030_4050,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0xaaaa_1020_3040_5060,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0xaa10_2030_4050_6070,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
...
const SDR_EXPECTED: [[u64; 4]; 8] = [
    ...
    [
        0x2030_4050_6070_80aa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0x3040_5060_7080_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0x4050_6070_80aa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0x5060_7080_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0x6070_80aa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0x7080_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
    [
        0x80aa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
        0xaaaa_aaaa_aaaa_aaaa,
    ],
...
fn collect_expected_store_mismatches(
    actual: [u8; 32],
    expected: [u64; 4],
    label: &str,
...
fn run_partial_load_matrix(memory_kind: MemoryKind, mode_64bit: bool) -> Result<(), String> {
    ...
    let cases = [
        PartialLoadCase {
            name: "LWL",
            emit: Assembler::make_lwl,
            width: 4,
            value: 0x00ef_0102,
            expected: &LWL_EXPECTED,
        },
        PartialLoadCase {
            name: "LWR",
            emit: Assembler::make_lwr,
            width: 4,
            value: 0x00ef_0102,
            expected: &LWR_EXPECTED,
        },
        PartialLoadCase {
            name: "LDL",
            emit: Assembler::make_ldl,
            width: 8,
            value: 0x1122_3344_5566_7788,
            expected: &LDL_EXPECTED,
        },
        PartialLoadCase {
            name: "LDR",
            emit: Assembler::make_ldr,
            width: 8,
            value: 0x1122_3344_5566_7788,
            expected: &LDR_EXPECTED,
        },
    ];
    for case in cases {
...
fn run_partial_store_matrix(memory_kind: MemoryKind, mode_64bit: bool) -> Result<(), String> {
    ...
    let cases = [
        PartialStoreCase {
            name: "SWL",
            emit: Assembler::make_swl,
            width: 4,
            value: 0x5060_7080,
            expected: &SWL_EXPECTED,
        },
        PartialStoreCase {
            name: "SWR",
            emit: Assembler::make_swr,
            width: 4,
            value: 0x5060_7080,
            expected: &SWR_EXPECTED,
        },
        PartialStoreCase {
            name: "SDL",
            emit: Assembler::make_sdl,
            width: 8,
            value: 0x1020_3040_5060_7080,
            expected: &SDL_EXPECTED,
        },
        PartialStoreCase {
            name: "SDR",
            emit: Assembler::make_sdr,
            width: 8,
            value: 0x1020_3040_5060_7080,
            expected: &SDR_EXPECTED,
        },
    ];
    for case in cases {
        if case.width == 8 && !mode_64bit {
        ...
        for offset in 0..case.width {
            ...
            program.push((case.emit)(GPR::T1, offset as i16, GPR::T0));
            program.push(Assembler::make_syscall() | (0x2e6 << 6));
            let entry = harness.write_program(true, &re_fetch_encode(&program));
...
impl Test for RePartialLoadOffsetMatrix {
    fn name(&self) -> &str {
        "RE user mode partial loads matrix (all offsets)"
    }
...
impl Test for RePartialStoreOffsetMatrix {
    fn name(&self) -> &str {
        "RE user mode partial stores matrix (all offsets)"
    }
