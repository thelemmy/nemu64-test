...
fn test<F: Fn(&mut RSPAssembler, E), F2: Fn(&mut [u8; 16], &[u8; 256], E, u32)>(
    base_offset: usize,
    load_emitter: F,
    calculate_expected: F2,
) -> Result<(), String> {
    ...
    soft_assert_eq(
        SPMEM::read_vector8_from_dmem(0x030),
        clear_vector,
        "V0 was modified eventhough it wasn't being written to",
    )?;
    soft_assert_eq(
        SPMEM::read_vector8_from_dmem(0x040),
        clear_vector,
        "V2 was modified eventhough it wasn't being written to",
    )?;
    ...
    for offset in TEST_MISALIGNMENTS {
        ...
        for e in TEST_ELEMENTS {
            ...
            soft_assert_eq2(
                SPMEM::read_vector8_from_dmem(memory_address),
                expected,
                || {
                    format!(
                        "Load with e={:?} from memory location {:x}",
                        e,
                        base_offset as u32 + offset
                    )
                },
            )?;
            memory_address += 0x10;
...
fn test_simple<F: Fn(&mut RSPAssembler, E), F2: Fn(u32) -> u32>(
    base_offset: usize,
    load_emitter: F,
    maximum_bytes_from_offset: F2,
) -> Result<(), String> {
    test(
        base_offset,
        load_emitter,
...
fn test_unpack<F: Fn(&mut RSPAssembler, E), const SHIFT: u32, const IFACTOR: u32>(
    base_offset: usize,
    load_emitter: F,
) -> Result<(), String> {
    test(
        ...
        |expected, test_data, e, offset| {
            ...
            for i in 0..8 {
                let element_offset =
                    (16 - (e as u32) + ((i as u32) * IFACTOR) + misalignment) & 0xF;
...
impl Test for LBV {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test_simple(
            0x1000,
            |assembler, e| assembler.write_lbv(VR::V1, e, 0x020, GPR::A0),
            |_offset| 1,
        )
    }
}
...
impl Test for LSV {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test_simple(
            0x1000,
            |assembler, e| assembler.write_lsv(VR::V1, e, 0x020, GPR::A0),
            |_offset| 2,
        )
    }
}
...
impl Test for LLV {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test_simple(
            0x1000,
            |assembler, e| assembler.write_llv(VR::V1, e, 0x020, GPR::A0),
            |_offset| 4,
        )
    }
}
...
impl Test for LDV {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test_simple(
            0x1000,
            |assembler, e| assembler.write_ldv(VR::V1, e, 0x020, GPR::A0),
            |_offset| 8,
        )
    }
}
...
impl Test for LQV {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test_simple(
            0x1000,
            |assembler, e| assembler.write_lqv(VR::V1, e, 0x020, GPR::A0),
...
impl Test for LRV {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test(
            0x1000,
            |assembler, e| assembler.write_lrv(VR::V1, e, 0x020, GPR::A0),
            |expected, test_data, e, offset| {
...
impl Test for LPV {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test_unpack::<_, 8, 1>(0x1000, |assembler, e| {
            assembler.write_lpv(VR::V1, e, 0x020, GPR::A0)
        })
    }
}
...
impl Test for LPVEndOfDMEM {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test_unpack::<_, 8, 1>(0xFD0, |assembler, e| {
            assembler.write_lpv(VR::V1, e, 0x020, GPR::A0)
        })
    }
}
...
impl Test for LUV {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test_unpack::<_, 7, 1>(0x1000, |assembler, e| {
            assembler.write_luv(VR::V1, e, 0x020, GPR::A0)
        })
    }
}
...
impl Test for LUVEndOfDMEM {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test_unpack::<_, 7, 1>(0xFD0, |assembler, e| {
            assembler.write_luv(VR::V1, e, 0x020, GPR::A0)
        })
    }
}
...
impl Test for LHV {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test_unpack::<_, 7, 2>(0x1000, |assembler, e| {
            assembler.write_lhv(VR::V1, e, 0x020, GPR::A0)
        })
    }
}
...
impl Test for LHVEndOfDMEM {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test_unpack::<_, 7, 2>(0xFD0, |assembler, e| {
            assembler.write_lhv(VR::V1, e, 0x020, GPR::A0)
        })
    }
}
...
impl Test for LFV {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test(
            0,
            |assembler, e| assembler.write_lfv(VR::V1, e, 0x020, GPR::A0),
            |expected, test_data, e, offset| {
                ...
                temp.set16(
                    0,
                    (test_data[aligned_address + ((misalignment.wrapping_add(e_)) & 0xF)] as u16)
                        << 7,
                );
                temp.set16(
                    1,
                    (test_data
                        [aligned_address + ((misalignment.wrapping_add(4).wrapping_sub(e_)) & 0xF)]
                        as u16)
                        << 7,
                );
                temp.set16(
                    2,
                    (test_data
                        [aligned_address + ((misalignment.wrapping_add(8).wrapping_sub(e_)) & 0xF)]
                        as u16)
                        << 7,
                );
                temp.set16(
                    3,
                    (test_data
                        [aligned_address + ((misalignment.wrapping_add(12).wrapping_sub(e_)) & 0xF)]
                        as u16)
                        << 7,
                );
                temp.set16(
                ...
                temp.set16(
                    6,
                    (test_data[aligned_address + ((misalignment.wrapping_sub(e_)) & 0xF)] as u16)
                        << 7,
                );
                temp.set16(
                    7,
...
impl Test for LFVZeroExtended {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test(
            0,
            |assembler, e| assembler.write_lfv(VR::V1, e, 0x0c0, GPR::A0),
            |expected, test_data, e, offset| {
                let mut temp = Vector::new();
                ...
                temp.set16(
                    0,
                    (test_data[aligned_address + ((misalignment + e_) & 0xF)] as u16) << 7,
                );
                temp.set16(
                    1,
                    (test_data[aligned_address + ((misalignment + 4 - e_) & 0xF)] as u16) << 7,
                );
                temp.set16(
                    2,
                    (test_data[aligned_address + ((misalignment + 8 - e_) & 0xF)] as u16) << 7,
                );
                temp.set16(
                    3,
                    (test_data[aligned_address + ((misalignment + 12 - e_) & 0xF)] as u16) << 7,
                );
                temp.set16(
                    4,
                    (test_data[aligned_address + ((misalignment + 8 - e_) & 0xF)] as u16) << 7,
...
impl Test for LWV {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        test(
            0,
            |assembler, e| assembler.write_lwv(VR::V1, e, 0x020, GPR::A0),
            |_, _, _, _| {
            ...
            for vt in TEST_VT {
                for e in TEST_ELEMENT {
                    ...
                    for i in 0..8 {
                        ...
                        expected[vt_base_index + reg_offset].set8(
                            i * 2,
                            test_data[base_address + ((odd_offset + e.index() + i * 2) & 0xF)],
                        );
                        expected[vt_base_index + reg_offset].set8(
                            i * 2 + 1,
                            test_data[base_address + ((odd_offset + e.index() + i * 2 + 1) & 0xF)],
                        );
                    }
